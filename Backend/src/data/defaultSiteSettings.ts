export const defaultSiteSettings = {
  ...
  mapLocation: {
    ...
    longitude: 35.7516,
    zoom: 15,
    label: "Dodoma Makulu SDA Church"
  },
  aboutChurch: {
    title: "Kuhusu Kanisa",
    content:
      "Karibu DODOMA MAKULU SDA CHURCH. Hapa unaweza kuweka historia fupi ya kanisa, maono, na huduma kuu.",
    imageUrl: "",
    imageAlt: "Kuhusu kanisa"
  },
  contactInfo: {
  ...
  libraryItems: [],
  faviconUrl: "",
  footerText: `(c) ${new Date().getFullYear()} DODOMA MAKULU SDA CHURCH.`
};
